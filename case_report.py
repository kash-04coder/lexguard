...
from report_generator import SCHEDULE_PAGE_1, SCHEDULE_PAGE_2
...
<h2>Certificate under Section 63(4)(c)</h2>
<div class="schedule">{_esc(SCHEDULE_PAGE_1)}</div>
<div class="schedule">{_esc(SCHEDULE_PAGE_2)}</div>
